...
public class HueActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private TextView bridgeIdTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bridgeIdTextView = (TextView)findViewById(R.id.bridge_id_text);
        ...
        getUserName = (Button) findViewById(R.id.getUserName);
        getUserName.setOnClickListener(this);
        openWebView = (Button) findViewById(R.id.WebView);
    ...
    private void setUserName(){
        try{
            ...
            bridgeIdTextView.setText(sb.toString());
            inputStream.close();
        } catch (Exception e){
            e.printStackTrace();
        }
    ...
    private void openWebView() {
        Uri uri = Uri.parse("http://10.0.0.1");
        Intent it = new Intent(Intent.ACTION_VIEW, uri);
        startActivity(it);
    }

    private void setGetUserName() {
        Intent intent = new Intent();
        Bundle bundle = new Bundle();

        intent.setClass(HueActivity.this, getUserName.class);
        String bridgeIp = getLastUsedBridgeIp();
        bundle.putString("IP", bridgeIp);
    ...
    private void updateUI(final UIState state, final String status) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                bridgeIdTextView.setVisibility(View.GONE);
                pushlinkImage.setVisibility(View.GONE);
                getUserName.setVisibility(View.GONE);
                ...
                switch (state) {
                    ...
                    case Connected:
                        bridgeIpTextView.setVisibility(View.VISIBLE);
                        bridgeIdTextView.setVisibility(View.VISIBLE);
                        getUserName.setVisibility(View.VISIBLE);
                        openWebView.setVisibility(View.VISIBLE);
                        bridgeDiscoveryButton.setVisibility(View.VISIBLE);
                        break;
                }
            }
